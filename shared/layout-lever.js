...
export const LAYOUT_DELTA_MAX_RATIO = 0.75
...
export function parseTransformTranslate(transform) {
 ...
 */
export function parseTransformParts(transform) {
 ...
 * @returns {string}
 */
export function formatTransformParts(parts) {
...
export function hasNonTranslateParts(parts) {
 ...
 */
export function readOffsetFromComputedStyle(cs) {
...
export function visualOffsetFromParts(parts) {
...
export function addVisualDelta(visual, deltaX, deltaY) {
  return {
...
export function formatTranslate(tx, ty) {
  return `translate(${tx}px, ${ty}px)`
}

export function formatMargin(x, y) {
...
export function formatXComputed(parts) {
  const v = visualOffsetFromParts(parts)
  if (v.tx === 0 && v.ty === 0) return '0'
  return formatTranslate(v.tx, v.ty)
}

export function formatApplyRecipe({ lever, xComputed, deltaX, deltaY }) {
...
export function isSuspiciousDelta(deltaX, deltaY, viewport) {
...
export function formatParentLayoutShort(parentLayout) {
 ...
 */
export function formatLayoutDeltaBufferLine(index, c) {
